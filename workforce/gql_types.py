...
class WorkforceEmployerInputType:
    ...
    foundation_date = graphene.String(required=True)
    association_name = graphene.String(required=True)
    association_membership_number = graphene.String(required=True)
    establishment_Name = graphene.String(required=True)
    establishment_date = graphene.String(required=True)
    status = graphene.Boolean(equired=True)
