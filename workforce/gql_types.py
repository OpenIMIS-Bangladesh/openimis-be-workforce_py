...
class WorkforceApplicationMovementInputType(OpenIMISMutation.Input):
    ...
    to_office_unit_organogram_id = graphene.String()
    from_office_unit_organogram_id = graphene.String()
    to_office_id = graphene.String()
    from_office_id = graphene.String()
    to_office_unit_id = graphene.String()
    from_office_unit_id = graphene.String()
    is_current = graphene.Boolean()
    is_cc = graphene.Boolean()
    is_committee_head = graphene.Boolean()
    is_committee_member = graphene.Boolean()
    to_employee_name_bng = graphene.String()
    from_employee_name_bng = graphene.String()
    to_employee_name_eng = graphene.String()
    from_employee_name_eng = graphene.String()
    to_employee_designation_bng = graphene.String()
    from_employee_designation_bng = graphene.String()
    to_office_name_bng = graphene.String()
    from_office_name_bng = graphene.String()
    to_employee_unit_name_bng = graphene.String()
