# Generated by Django 4.2.25 on 2026-05-20 14:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0311_alter_historicalworkforcecommitteeusermap_is_representative_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workforce_document', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='website_document', to='workforce.workforcedocument')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workforce_document', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='workforce.workforcedocument')),
            ],
            options={
                'verbose_name': 'historical website legal guideline',
                'verbose_name_plural': 'historical website legal guidelines',
