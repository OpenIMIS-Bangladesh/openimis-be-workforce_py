# Generated by Django 4.2.16 on 2025-03-24 08:14
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0049_historicalworkforceapplication_is_submitted_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkforceDocumentType',
            fields=[
                ...
                ('field_id', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='HistoricalWorkforceDocumentType',
            fields=[
            ...
            options={
                'verbose_name': 'historical workforce document type',
                'verbose_name_plural': 'historical workforce document types',
