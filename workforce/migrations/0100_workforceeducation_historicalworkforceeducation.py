# Generated by Django 4.2.16 on 2025-07-21 18:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0099_seed_more_document_type_data'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkforceEducation',
            fields=[
                ...
                ('education_board', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='educations', to='workforce.workforceapplication')),
                ...
                ('workforce_employee', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='educations', to='workforce.workforceemployee')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalWorkforceEducation',
            fields=[
            ...
            options={
                'verbose_name': 'historical workforce education',
                'verbose_name_plural': 'historical workforce educations',
