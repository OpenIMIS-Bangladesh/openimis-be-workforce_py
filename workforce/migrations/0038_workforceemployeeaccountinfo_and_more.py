# Generated by Django 4.2.16 on 2025-02-27 09:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0037_rename_employee_id_historicalworkforceemployeedesignation_workforce_employee_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkforceEmployeeAccountInfo',
            fields=[
                ...
                ('beneficiary_id', models.CharField(max_length=30)),
                ('on_behalf_of', models.CharField(max_length=30)),
                ('account_holder_name', models.CharField(max_length=255)),
                ('account_number', models.CharField(max_length=50)),
                ('status', models.CharField(blank=True, max_length=30, null=True)),
                ('bank', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='workforce_dependent_bank', to='workforce.bank')),
                ('permanent_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='dependent_permanent_location', to='location.location')),
                ('present_location', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='dependent_present_location', to='location.location')),
        ...
        migrations.CreateModel(
            name='HistoricalWorkforceEmployeeAccountInfo',
            fields=[
            ...
            options={
                'verbose_name': 'historical workforce employee account info',
                'verbose_name_plural': 'historical workforce employee account infos',
