# Generated by Django 4.2.16 on 2025-04-09 09:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0052_seed_workforce_document_type'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkforceDocumentMap',
            fields=[
                ...
                ('mapped_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='mapped_by', to='core.interactiveuser')),
                ...
                ('workforce_document_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='workforce_document_type', to='workforce.workforcedocumenttype')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoricalWorkforceDocumentMap',
            fields=[
                ...
                ('mapped_by', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='core.interactiveuser')),
                ...
                ('workforce_document_type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='workforce.workforcedocumenttype')),
            ],
            options={
                'verbose_name': 'historical workforce document map',
                'verbose_name_plural': 'historical workforce document maps',
