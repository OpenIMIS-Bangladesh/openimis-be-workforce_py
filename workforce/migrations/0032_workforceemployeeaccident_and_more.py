# Generated by Django 4.2.16 on 2025-02-25 11:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('workforce', '0031_workforceemployeedesignation_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='WorkforceEmployeeAccident',
            fields=[
                ...
                ('accident_location', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='employee_accident_location', to='location.location')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='employee', to='workforce.workforceemployee')),
        ...
        migrations.CreateModel(
            name='HistoricalWorkforceEmployeeAccident',
            fields=[
                ...
                ('accident_location', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='location.location')),
            ...
            options={
                'verbose_name': 'historical workforce employee accident',
                'verbose_name_plural': 'historical workforce employee accidents',
