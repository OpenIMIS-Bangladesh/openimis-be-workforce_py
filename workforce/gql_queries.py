...
class WorkforceFactoryGQLType(DjangoObjectType):
    class Meta:
        ...
        filter_fields = {
            ...
            **prefix_filterset("location__", LocationGQLType._meta.filter_fields),
            **prefix_filterset("office_location__", LocationGQLType._meta.filter_fields),
            **prefix_filterset("workforce_representative__", WorkforceRepresentativeGQLType._meta.filter_fields),
            "address": ["exact", "icontains"],
            "office_address": ["exact", "icontains"],
            "phone_number": ["exact", "icontains"],
            "future_date": ["exact", "icontains"],
            "date_of_eis_incorporation": ["exact", "icontains"],
            "date_of_factory_establishment": ["exact", "icontains"],
            "membership_no": ["exact", "icontains"],
            "business_sector": ["exact", "icontains"],
            "license_no": ["exact", "icontains"],
            "lima_registration_number": ["exact", "icontains"],
            "approximate_number_of_employee": ["exact", "icontains"],
            "email": ["exact", "icontains"],
            "website": ["exact", "icontains"],
            "status": ["exact", "isnull"],
...
class WorkforceApplicationGQLType(DjangoObjectType):
    ...
    class Meta:
        ...
        filter_fields = {
            "id": ["exact"],
            "workforce_employee_verification": [],
            "workforce_employee_verification_remarks": [],
            "employee_designation_info": [],
            "employee_document_info": [],
            "employee_bank_info": [],
            "employee_bank_info_verification": [],
            "employee_bank_info_verification_remarks": [],
            "employee_dependent_info": [],
            "employee_dependent_info_verification": [],
            "employee_dependent_info_verification_remarks": [],
            "employee_accident_info": [],
            "employee_accident_info_verification": [],
            "employee_accident_info_verification_remarks": [],
            "employee_children_info": [],
            "employee_children_info_verification": [],
            "employee_children_info_verification_remarks": [],
            "applicant_info": [],
            "applicant_info_verification": [],
            "applicant_info_verification_remarks": [],
            "institution_info": [],
            "institution_info_verification": [],
            "institution_info_verification_remarks": [],
            "doctors_entry": [],
            "doctors_entry_verification": [],
            "doctors_entry_verification_remarks": [],
    ...
    class Meta:
        ...
        filter_fields = {
            ...
            **prefix_filterset("workforce_application__", WorkforceApplicationGQLType._meta.filter_fields),
            ...
            "nid": ["exact"],
            "birth_certificate_no": ["exact"],
            **prefix_filterset("bank__", WorkforceBankGQLType._meta.filter_fields),
            "bank_account_no": ["exact"],
            "bank_account_holder_name": ["exact", "icontains"],
            "eis_payment_type": ["exact"],
            "eis_calculated_amount": ["exact"],
            "eis_approved_amount": ["exact"],
            "eis_monthly_amount": ["exact"],
            ...
            "death_date": ["exact"],
            "disability_status": ["exact", "icontains"],
            "disability_type": ["exact", "icontains"],
...
class WorkforceApplicationMovementFilter(django_filters.FilterSet):
    ...
    def filter_application_id(self, queryset, name, value):
        try:
            _, real_id = from_global_id(value)
    ...
    class Meta:
        ...
        fields = {
            ...
            "from_office_designation_id": ["exact"],
            "to_office_designation_id": ["exact"],
            "from_role_id": ["exact"],
            "to_role_id": ["exact"],
            "revert_note": ["exact"],
            "status": ["exact", "icontains"],
...
class WorkforceGenderwiseMatrixGQLType(graphene.ObjectType):
    total_applicant = graphene.String()
    total_dependent = graphene.String()
    male_applicant = graphene.String()
    female_applicant = graphene.String()
...
class WorkforceEisPaymentDisbursementGQLType(DjangoObjectType):
    class Meta:
        model = WorkforceEisPaymentDisbursement
        interfaces = (graphene.relay.Node,)
        filter_fields = {
            "id": ["exact"],
            # **prefix_filterset("workforce_application__", WorkforceApplicationGQLType._meta.filter_fields),
            ...
            "month_index": ["exact"],
            "year": ["exact"],
            "disbursement_date": ["exact"],
            # **prefix_filterset("disbursed_by__", InteractiveUserGQLType._meta.filter_fields),
            "disbursed_by": ["exact"],
...
class WorkforceAssociationUserMapGQLType(DjangoObjectType):
    class Meta:
        model = WorkforceAssociationUserMap
        interfaces = (graphene.relay.Node,)
        filter_fields = {
            "id": ["exact"],
...
class WorkforceEisBankAdviceGQLType(DjangoObjectType):
    class Meta:
        model = WorkforceEisBankAdvice
        interfaces = (graphene.relay.Node,)
        filter_fields = {
            "id": ["exact"],
            "is_confirmed": ["exact", "icontains"],
            "advice_date": ["exact", "icontains"],
            "remarks": ["exact", "icontains"],
